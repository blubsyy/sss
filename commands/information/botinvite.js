    ...
    run: async (client, message, args) => {
        ...
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .setImage('https://cdn.discordapp.com/banners/1092374628556615690/a_46a262269a5486434bb4025437a6d261.gif?size=4096');  
            ...
            guildChunks.forEach((chunk, chunkIndex) => {
                chunk.forEach((guildInfo, index) => {
                    ...
                    let description = `
                        <:MekoInvite:1266028937302118433> **[Server Invite](${invite.url})**
                        <:MekoSearch:1266027859559059598> **Server Members : ${guild.memberCount}**
                    `;
