            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:cross_mark:1267383549623930892> You must have \`Manage Roles\` permissions to use this command.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:cross_mark:1267383549623930892> I don't have \`Manage Roles\` permissions to execute this command.`
                        )
                ]
            })
        }
        ...
        if (input === 'add') {
            ...
            if (!data) {
                ...
                const setupRoleEmbed = new MessageEmbed()
                    ...
                    .setDescription(
                        `<:tick:1267383653512773705> Your server has been configured successfully. You can now use custom roles and enjoy the enhanced features hassle-free!`
                    )
                    .setFooter(
            ...
            if (data) {
                if (data.names.length > 50) {
                    const embed = new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<:cross_mark:1267383549623930892> Sorry, you've reached the limit of **50** custom role setups. Please remove some setups to add new ones.`
                        )
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<:cross_mark:1267383549623930892> ${message.guild.prefix}setup add <name> <role>`
                            )
                    ]
                })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<:cross_mark:1267383549623930892> **Custom role** names cannot contain **mentions**. Please provide a different **name**.`
                            )
                    ]
                });
            }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<:cross_mark:1267383549623930892> ${message.guild.prefix}setup add ${args[1]} <role>`
                            )
                    ]
                })
            const role =
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<:cross_mark:1267383549623930892> Role **not** found!`
                            )
                    ]
                })
            if (role.managed)
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<:cross_mark:1267383549623930892> <@&${role.id}> isn't a **server** role!`
                            )
                    ]
                })
            let array = [
            ...
            if (
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setDescription(
                                `<:cross_mark:1267383549623930892> I can't **add** <@&${role.id}> in my **custom role** list because it has ${new Permissions(
            ...
            if (!data) {
                ...
                const setupRoleEmbed = new MessageEmbed()
                    ...
                    .setTitle(`Server Configuration Complete!`)
                    .setDescription(
                        `<:tick:1267383653512773705> Congratulations! Your server has been configured successfully. You can now use custom roles and enjoy the enhanced features hassle-free! `
                    )
                    .setFooter(
                        `Setup completed by ${message.author.tag}`,
                        message.author.displayAvatarURL({ dynamic: true })
            ...
            if (!data.names.length) {
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setDescription(
                        `<:cross_mark:1267383549623930892> Oops! It seems like there are no custom role setups configured yet. Use \`${message.guild.prefix}setup\` to create custom roles.`
                    )
                return message.channel.send({ embeds: [embed] })
            }
            ...
            if (roleIndex === -1) {
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setDescription(
                        `<:cross_mark:1267383549623930892> Oops! The role with the name **${roleName}** couldn't be found in my custom role setups. Double-check the name and try again.`
                    )
                return message.channel.send({ embeds: [embed] })
            }
            ...
            if (!data) {
                const embed = new MessageEmbed()
                    ...
                    .setDescription(
                        ` Oops! There's nothing to display for custom role setups.`
                    )
                    .setAuthor({
                        name: message.guild.name,
                        iconURL:
            ...
            if (
                ...
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setTitle(`<:cross_mark:1267383549623930892> Role Position Issue`)
                    .setDescription(
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setColor(client.color)
                        .setDescription(
                            `\n<:arrow:1267432055101460586> ${message.guild.prefix}setup add <name> <role>\nSetups a role with the provided name.\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup remove <name>\nRemoves a role with the provided name.\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup reqrole <role>\nSetups a requirement role.\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup add girl <role>\nSetups a role for girls\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup add guest <role>\nSetups a role for guests.\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup add vip <role>\nSetups a role for vip members.\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup add official <role>\nSetups a role for official mebers.\n\n<:arrow:1267432055101460586> ${message.guild.prefix}setup list\nShows you the list of all custom roles.\n\n<:arrow:1267432055101460586>${message.guild.prefix}setup config\nShows you the configuration of custom roles.`
                        )
                ]
            })
        }
