            ...
            if(!role) {
                return message.channel.send({
                    embeds: [
                        embed
                            .setColor(client.color)
                            .setDescription(                ` <:cross_mark:1267383549623930892> You didn't provided a valid role.\n\`${message.guild.prefix}role all <role>\``
                            )
                    ]
                })
            }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:cross_mark:1267383549623930892> You didn't used the command correctly.\n\`${message.guild.prefix}role <user> <role>\``
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:cross_mark:1267383549623930892> You didn't provided a valid role.\n\`${message.guild.prefix}role <user> <role>\``
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:cross_mark:1267383549623930892> This Role Is Managed By Integration`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:warn:1267383282111086612>I can't provide this role as your highest role is either below or equal to the provided role.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:tick:1267383653512773705> Successfully removed <@&${role.id}> from <@${member.id}>.`
                        )
                ]
            })
        } else {
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<:tick:1267383653512773705> Successfully added <@&${role.id}> to <@${member.id}>.`
                        )
                ]
            })
        }
