  ...
  run: async (client, message, args) => {
    ...
    if (!listData) {
      const embed = new MessageEmbed()
        .setTitle("<:invitesss:1259376190024716369> **Invalid list type** ")
        .setDescription("<a:stolen_emoji:1262020623111159839> **Please provide 'admin', 'bot', 'ban', 'inrole <role name/ID/mention>', 'boosters', 'emojis', or 'roles'.** ")
        .setColor("#000000");
