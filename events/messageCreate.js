...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.com/invite/xPS8yUc7qA'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`#0x000000`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.com/invite/xPS8yUc7qA) was removed.\nClick [here](https://discord.com/invite/xPS8yUc7qA) To Buy [Premium](https://discord.com/invite/xPS8yUc7qA).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`#0x000000`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.com/invite/xPS8yUc7qA) was removed.\nClick [here](https://discord.com/invite/xPS8yUc7qA) To Buy [Premium](https://discord.com/invite/xPS8yUc7qA).`
                                        )
                                ],
                                components: [premrow]
                            })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            ...
                            .setDescription(
                                `> <:tick:1267383653512773705> **My Prefix for this server is **\`${message.guild.prefix}\`. **Try**\` ${message.guild.prefix}\help\` **To Get The Command List.**`
                            )
                            .setFooter({
                                text: `– Created By E N E M Y .`,
                                    ...
                                    await interaction.reply({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<:tick:1267383653512773705> | Only ${message.author} can use this button.`
                                                )
                                        ],
                                    ...
                                    await interaction.reply({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<:tick:1267383653512773705> Permissions removed successfully.`
                                                )
                                        ],
                                        ephemeral: true // Only visible to the user who clicked the button
                                    })
                                    ...
                                    await interaction.reply({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                     `<:cross_mark:1267383549623930892> I don't have sufficient permissions to clear permissions from the role. Please make sure my role position is higher than the role you're trying to modify.`
                                                )
                                        ],
                                        ephemeral: true // Only visible to the user who clicked the button
                                    })
                                ...
                                await message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<:cross_mark:1267383549623930892> I can't provide this role as my highest role is either below or equal to the provided role.`
                                            )
                                    ]
                                })
                                ...
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<:tick:1267383653512773705> The role ${role} has been successfully removed from ${member}`
                                            )
                                    ]
                                })
                            } else {
                                ...
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                 `<:tick:1267383653512773705> The role ${role} has been successfully added to ${member}`
                                            )
                                    ]
                                })
                            }
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.com/invite/xPS8yUc7qA)',
                                    true
                                )
                                .setTimestamp()
